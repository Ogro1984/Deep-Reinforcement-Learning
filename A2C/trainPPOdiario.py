  ...
  # Entorno personalizado para el trading de acciones
    ...
    def objective(trial,train_df):
        ...
        model = PPO('MlpPolicy', vec_env, learning_rate=learning_rate, gamma=gamma,
                    ...
                    gae_lambda=gae_lambda, n_steps =n_steps, clip_range=clip_range,verbose=1,device="cpu")
    ...
    best_params = optimize_hyperparameters(train_df,study_name='a2ceurjpy_D1_4PPO', n_trials=15)
    model = train_a2c_with_best_params(train_df, best_params,total_timesteps=10000,model_path="a2c_eurjpy_D1PPO.zip")
    ...
    test_a2c_model(model,samples_200_to_100,nombre="test_plot_eurjpy_D1_PPO.png")
    evaluate_with_multiple_seeds_and_batches(model, test_df, excel_path="test_results_eurjpy_D1PPO.xlsx", num_seeds=10, batch_size=3000) 
    ...
    best_params = optimize_hyperparameters(train_df,study_name="PPO_optimizationGBPUSD_D1_PPO", n_trials=15)
    model = train_a2c_with_best_params(train_df, best_params,model_path="PPO_GBPUSD_D1PPO.zip")
    test_a2c_model(model,samples_200_to_100,nombre="test_plot_GBPUSD_D1PPO.png")
    evaluate_with_multiple_seeds_and_batches(model, test_df, excel_path="test_results_GPBUSD_D1PPO.xlsx", num_seeds=10, batch_size=3000) 
    ...
    samples_200_to_100 = test_df[-300:-100]  
    # # Entrenar el modelo con los datos de entrenamiento
    best_params = optimize_hyperparameters(train_df, study_name="a2c_optimization_eurusdD1PPO",n_trials=15)
    model = train_a2c_with_best_params(train_df, best_params,model_path="PPO_EURUSD_D1.zip")
    test_a2c_model(model,samples_200_to_100,nombre="test_plot_EURUSD_D1PPO.png")
    evaluate_with_multiple_seeds_and_batches(model, test_df, excel_path="test_results_eurusd_D1PPO.xlsx", num_seeds=10, batch_size=3000) 
