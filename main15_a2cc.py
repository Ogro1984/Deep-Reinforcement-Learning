...
def train_a2c_model(train_data_path, base_path):
    """
                            ...
                            for vf_coef in vf_coefs:
                                for max_grad_norm in max_grad_norms:
                                    for gae_lambda in gae_lambdas:
                                            ...
                                            model_name = f"ppo_lr{learning_rate}_gamma{gamma}_nsteps{n_steps}_ent{ent_coef}_vf{vf_coef}_gradnorm{max_grad_norm}_gae{gae_lambda}"
                    ...
                    for window_size in os.listdir(filter_path):
                        ...
                        for filename in os.listdir(window_path):
                            if filename.endswith(".csv"):
                                ...
                                training_folder = os.path.join(train_base_path, "entrenamientos", "A2C")
