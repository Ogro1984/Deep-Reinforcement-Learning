...
def analyze_and_preprocess_data(df, nombre_fichero, ventana):
    """
    Performs data preprocessing, EDA, correlation analysis, pattern identification,
    anomaly detection, and advanced visualization on the given DataFrame.
    """
...
# Ejemplo de uso (dentro de la función calcular_diferencia_promedio_historico)
# Después de cargar los datos en train_data y test_data, puedes llamar a la función:
# analyze_and_preprocess_data(train_data.copy(), nombre_fichero, ventana)
# analyze_and_preprocess_data(test_data.copy(), nombre_fichero, ventana)
    ...
    for filename in os.listdir(folder_path):
            ...
            try:
                ...
                if '15min' in filename:
                    calcular_diferencia_promedio_historico(df_diario, 50, 100, 150, nombre_fichero, 0.7)
                else:
                    calcular_diferencia_promedio_historico(df_diario, 10, 5, 200, nombre_fichero, 0.7)
