...
# Obtener información del conjunto de datos de prueba
   ...
   # Guardar las estadísticas de prueba en un archivo CSV
    ...
    with open(csv_file, mode='a', newline='') as f:
        ...
        if not file_exists:
            writer.writerow([
                "Algorithm", "Learning Rate", "Gamma", "N Steps", "Ent Coef", "VF Coef", "Max Grad Norm", "RMS Prop Eps", "GAE Lambda", "Batch Size",
        ...
        writer.writerow([
            algorithm_name, params_dict.get("lr", ""), params_dict.get("gamma", ""), params_dict.get("nsteps", ""),
            params_dict.get("ent", ""), params_dict.get("vf", ""), params_dict.get("gradnorm", ""), params_dict.get("rms", ""), params_dict.get("gae", ""), params_dict.get("batch", ""),
